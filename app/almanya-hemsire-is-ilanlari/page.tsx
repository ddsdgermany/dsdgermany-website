...
export const metadata: Metadata = {
  ...
  description:
    "Almanya'da hemşire olarak çalışmak isteyen adaylar için iş fırsatları, denklik, Almanca, vize ve işe yerleştirme süreçleri hakkında bilgi alın.",
};

const whatsappUrl =
  "https://wa.me/905550341617?text=Merhaba%2C%20Almanya%20hem%C5%9Fire%20i%C5%9F%20ilanlar%C4%B1%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum.";
      ...
      <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 px-6 py-20 text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-blue-100">
            Almanya’da hemşire olarak çalışmak isteyen adaylara işveren
            görüşmeleri, denklik, vize ve işe yerleşme süreçlerinde
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-5 leading-8 text-slate-600">
                Adayın eğitim, Almanca ve mesleki deneyim durumu işveren
                seçeneklerini etkileyebilir. Başvuru öncesinde belgeleriniz
                incelenerek size uygun yol haritası hazırlanır.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-blue-50 p-8">
              <ul className="space-y-5">
                <li className="flex gap-3">
                  ...
                  Hemşirelik eğitimi veya diploması bulunan adaylar
                </li>
                ...
                <li className="flex gap-3">
                  <span className="font-bold text-blue-700">✓</span>
                  Yoğun bakım, ameliyathane veya klinik deneyimi bulunanlar
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <article className="rounded-3xl bg-white p-8 shadow-sm">
              ...
              <p className="mt-3 leading-7 text-slate-600">
                Belgelerin hazırlanması ve denklik sürecinin takip edilmesi
                konusunda yönlendirme sağlanır.
              </p>
            </article>

            <article className="rounded-3xl bg-white p-8 shadow-sm">
              <div className="text-3xl">🏥</div>
              <h3 className="mt-5 text-xl font-bold">İşveren görüşmesi</h3>
              <p className="mt-3 leading-7 text-slate-600">
                Profilinize uygun hastane, klinik ve bakım kuruluşlarıyla
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              [
                ...
                "Dil, diploma ve deneyiminize uygun yol belirlenir.",
              ],
              [
                "03",
                "İşveren görüşmesi",
                "Uygun işverenlerle online görüşme gerçekleştirilir.",
              ],
              [
                "04",
                "İş sözleşmesi",
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 space-y-4">
            ...
            <details className="rounded-2xl bg-white p-6">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Bazı pozisyonlarda denklik süreci devam ederken başvuru
                değerlendirilebilir. Kesin durum adayın belgelerine ve
                işverene göre belirlenir.
              </p>
            </details>
            ...
            <details className="rounded-2xl bg-white p-6">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Denklik, işveren, vize randevusu ve belgelerin durumuna göre
                süre değişebilir. İncelemeden kesin süre vermek mümkün
                değildir.
              </p>
            </details>
          </div>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-6xl rounded-3xl bg-blue-950 px-8 py-14 text-center text-white">
          <h2 className="text-3xl font-bold md:text-4xl">
            Almanya’da hemşirelik kariyerinize başlayın
          </h2>

          <p className="mx-auto mt-5 max-w-2xl leading-8 text-blue-100">
            Eğitim, Almanca ve mesleki deneyim bilgilerinizi paylaşın.
            Profilinizi inceleyerek size uygun seçenekler hakkında bilgi
            verelim.
          </p>

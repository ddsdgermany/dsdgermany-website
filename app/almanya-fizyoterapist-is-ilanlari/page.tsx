...
export const metadata: Metadata = {
  title: "Almanya Fizyoterapist İş İlanları | DSD Germany",
  description:
    "Almanya'da fizyoterapist olarak çalışmak isteyen adaylar için iş fırsatları, denklik, Almanca, vize ve işe yerleştirme süreçleri hakkında bilgi alın.",
};

const whatsappUrl =
  "https://wa.me/905550341617?text=Merhaba%2C%20Almanya%20fizyoterapist%20i%C5%9F%20ilanlar%C4%B1%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum.";
      ...
      <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 px-6 py-20 text-white">
        <div className="mx-auto max-w-6xl">
          <p className="mb-4 font-semibold text-yellow-300">
            Almanya’da fizyoterapi kariyeri
          </p>

          <h1 className="max-w-4xl text-4xl font-bold leading-tight md:text-6xl">
            Almanya Fizyoterapist İş İlanları
          </h1>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-blue-100">
            Almanya’da fizyoterapist olarak çalışmak isteyen adaylara işveren
            görüşmeleri, denklik, vize ve işe yerleşme süreçlerinde profesyonel
            destek sağlıyoruz.
          </p>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-5 leading-8 text-slate-600">
                Eğitim, Almanca seviyesi, denklik durumu ve mesleki deneyim
                işveren seçeneklerini etkileyebilir. Belgeleriniz incelenerek
                size uygun yol haritası hazırlanır.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-blue-50 p-8">
              <ul className="space-y-5">
                <li className="flex gap-3">
                  ...
                  Fizyoterapi eğitimi veya diploması bulunan adaylar
                </li>
                ...
                <li className="flex gap-3">
                  <span className="font-bold text-blue-700">✓</span>
                  Klinik, rehabilitasyon veya bakım deneyimi bulunan adaylar
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="bg-slate-50 px-6 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <article className="rounded-3xl bg-white p-8 shadow-sm">
              <div className="text-3xl">🏥</div>
              <h3 className="mt-5 text-xl font-bold">Klinik görüşmeleri</h3>
              <p className="mt-3 leading-7 text-slate-600">
                Profilinize uygun klinik, rehabilitasyon merkezi ve sağlık
                kuruluşlarıyla görüşme süreci organize edilir.
              </p>
            </article>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              [
                "03",
                "İşveren görüşmesi",
                "Uygun kliniklerle online görüşme gerçekleştirilir.",
              ],
              [
                "04",
                "İş sözleşmesi",
      ...
      <section className="bg-blue-50 px-6 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 space-y-4">
            ...
            <details className="rounded-2xl bg-white p-6">
              <summary className="cursor-pointer font-bold">
                Mesleki deneyim gerekli mi?
              </summary>
              <p className="mt-4 leading-7 text-slate-600">
                Mesleki deneyim işveren seçeneklerini artırabilir. Ancak bazı
                pozisyonlarda yeni mezun adaylar da değerlendirilebilir.
              </p>
            </details>
          </div>
        </div>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-6xl rounded-3xl bg-blue-950 px-8 py-14 text-center text-white">
          <h2 className="text-3xl font-bold md:text-4xl">
            Almanya’da fizyoterapist kariyerinize başlayın
          </h2>
